...
const REVIEWS = [
  {
    title: "나를 다시 찾고 더 나은 인생을 만나다",
    author: "광주하남 카네기 50기 수료생 · 최고경영자 과정 추천서",
    excerpt: "수많은 교육을 이수해 봤지만 데일카네기 교육은 단연코 달랐습니다. 12회 교육이 12개월을 함께한 듯 친숙하고 따뜻한 형제애를 느낄 수 있는 과정입니다.",
    paras: [
      "수많은 교육을 이수해 봤지만, 데일카네기 교육은 단연코 달랐습니다. 나 자신을 들여다보고 비전을 세우고 나의 정체성을 찾을 수 있는 교육이었고, 나를 사랑하게 되고 개인·사업·가정 모두 성장되는 놀라운 경험이었습니다. 12회 교육이 12개월을 함께한 듯 친숙하고 따뜻한 형제애를 느낄 수 있는 과정입니다.",
      "제가 데일카네기를 추천하는 이유는 세 가지입니다. 첫째, 자신감이 생겨 당당해집니다. 무대공포증도 극복하고, 발표가 두렵지 않고, 어느 모임에서도 자신감 넘치는 진행과 발표를 하실 수 있습니다. 둘째, 순수한 형제애를 느끼는 동기가 생깁니다. 조건 없는 우정과 인간애는 힘들고 지칠 때 큰 힘이 됩니다. 셋째, 선·후배로 엮여 사업에 날개를 달 수 있습니다. 아무 조건 없는 도움과 응원, 카네기 동문들과의 협력으로 사업의 성장을 이룰 수 있습니다.",
      "교육은 매주 4시간씩 12회차로 진행되고, 전기수 환영의 밤·경기권 신입생 체육대회·수료식이라는 세 번의 큰 행사와 동기·코치님들과 함께하는 졸업여행이 있습니다. 데일카네기 인간관계론·스트레스론·스피치론을 중심으로 매 회차 독서과제와 2분 발표가 이어지는데, 예습을 꼭 하시면 큰 도움이 됩니다.",
      "나의 성장, 사업의 성장, 인간관계의 성장, 그리고 성공하는 인생. 데일카네기 최고경영자 과정의 가치는 직접 경험하시면 분명 인생이 바뀝니다. 꼭 오셔서 이 좋은 과정을 경험하시고, 선후배로 만나 더 오래오래 함께해요.",
    ],
  },
  {
