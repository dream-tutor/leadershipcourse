...
// ※ 아래 5개는 09.08·09.21 두 목록 모두에 없는 미개강 기수(이전 브로슈어 기준) — 본사 확인 후 유지/삭제
//    목포 CEO 1 · 여수 CEO 3 · 서울 DCC(단기) 3 · 서울 HIP 148 · 전북 차세대 경영자 11
// ------------------------------------------------------------
const SCHEDULE = [
...
const REVIEWS = [
  {
    title: "나를 다시 찾고, 더 나은 인생을 만났습니다",
    author: "광주하남 카네기 50기 수료생 · 최고경영자 과정 추천서",
    excerpt: "교육이라면 많이 받아 봤지만 이 과정은 달랐습니다. 열두 번의 수업이 열두 달을 함께 보낸 것처럼 가까워지는 동기들이 생깁니다.",
    paras: [
      "교육이라면 그동안 많이 받아 봤습니다. 그런데 이 과정은 달랐습니다. 나를 들여다보고 비전을 세우는 동안 내가 어떤 사람인지 다시 알게 됐고, 나를 아끼게 되니 개인도, 사업도, 가정도 같이 자라는 경험을 했습니다. 열두 번의 수업이 열두 달을 함께 보낸 것처럼 형제 같은 동기들이 생긴 것도 이 과정이 준 선물입니다.",
      "제가 이 과정을 권하는 이유는 세 가지입니다. 첫째, 당당해집니다. 무대가 무섭던 사람이 발표를 즐기게 되고 어떤 모임에서도 자신 있게 앞에 섭니다. 둘째, 조건 없이 서로를 챙기는 동기가 생깁니다. 힘들고 지칠 때 가장 먼저 떠오르는 사람들입니다. 셋째, 선후배가 사업의 날개가 됩니다. 대가를 바라지 않는 도움과 동문 간의 협력이 사업을 한 단계 키웁니다.",
      "수업은 한 주에 한 번, 4시간씩 열두 번입니다. 앞 기수가 마련해 주는 환영의 밤, 경기권 기수들이 모이는 신입생 체육대회, 수료식까지 세 번의 큰 행사가 있고 동기·코치님들과 졸업여행도 갑니다. 카네기 인간관계론·스트레스론·스피치론이 뼈대이고, 매 시간 독서과제와 2분 발표가 있습니다. 미리 읽고 오시면 수업이 훨씬 잘 들어옵니다.",
      "나의 성장, 사업의 성장, 관계의 성장, 그리고 인생의 성장. 직접 겪어 보시면 압니다. 꼭 오셔서 경험하시고, 선후배로 만나 오래오래 함께합시다.",
    ],
  },
  {
